...
def FILTR_FREQ(signal1, signal2, fs, freq_low, freq_high):
    sum_signal = []
...
def WHO_BIGGER(signal1, signal2, signal3, signal4):
    mean1 = 0
    mean2 = 0
    mean3 = 0
    mean4 = 0
...
def BREATH_FILT(signal1, signal2, signal3, signal4):
    order = 2
    global lowcut_br
    global highcut_br

    freq_br_r1 = FILTR_FREQ(signal1, signal2, fsB, lowcut_br, highcut_br)
    freq_br_r2 = FILTR_FREQ(signal3, signal4, fsB, lowcut_br, highcut_br)
    '''Находим сигнал с большей амплитудой'''
    who = WHO_BIGGER(signal1, signal2, signal3, signal4)
    if who == 0:
        freq_sum = freq_br_r1
    elif who == 1:
        freq_sum = freq_br_r2
...
def HEART_FILT(signal_r1_1, signal_r1_2, signal_r2_1, signal_r2_2):
    ...
    freq_hb_r1 = FILTR_FREQ(signal_r1_1, signal_r1_2, fsB, lowcut_hb, highcut_hb)
    freq_hb_r2 = FILTR_FREQ(signal_r2_1, signal_r2_2, fsB, lowcut_hb, highcut_hb)
...
def BreathRateCounter(signal_r1_1, signal_r1_2, signal_r2_1, signal_r2_2, time):
    ...
    signalfilt_br_r2_2 = BREATH_FILT(signal_r1_1, signal_r1_2, signal_r2_1, signal_r2_2)
    ...
    signalfilt_hb_r1_1_w, signalfilt_hb_r1_2_w, signalfilt_hb_r2_1_w, signalfilt_hb_r2_2_w\
        = HEART_FILT(signalfilt_hb_r1_1, signalfilt_hb_r1_2, signalfilt_hb_r2_1, signalfilt_hb_r2_2)
